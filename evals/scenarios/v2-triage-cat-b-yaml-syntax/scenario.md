# v2 Migration Triage — Category B: YAML Syntax Error

## Background

A user is migrating their dbt project to dbt v2. Their `dbt_project.yml` has a YAML syntax error: `vars::` (double colon) instead of `vars:` (single colon). This causes v2 to flag it as dbt1060 (unexpected key) because the double colon creates an invalid YAML structure.
